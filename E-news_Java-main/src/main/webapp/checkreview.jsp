...
<div class="table-container">
    <h1 class="text-center text-orange mb-4">Contacted Messages</h1>
        ...
        <table class="table table-striped">
            <!-- ... existing table structure ... -->
                ...
                <tr>
                    ...
                    <th scope="col" class="text-orange text-center">Profession</th>
                    <th scope="col" class="text-orange text-center">Review</th>                   
           ...
           <%
                    ...
                    <tr>
                        ...
                        <td class="text-center"><%= rs.getString("name") %></td>
                                                <td class="text-center"><%= rs.getString("profession") %></td>
                        
                        <td class="text-center"><%= rs.getString("review") %></td>
                                             <td class="text-center"><img style="width:100px;height:100px;" src="<%= rs.getString("pic") %>"></td>
                     
                      
                     
                        <td class="text-center">
                            <button class="bg-danger">
                                <a href="deletereview.jsp?id=<%= rs.getInt("id") %>">Delete</a>
                            </button>
                        </td>
                    </tr>
                    <%

        ...
        <table class="table table-striped">
            <!-- ... existing table structure ... -->
                ...
                <tr>
                    ...
                    <th scope="col" class="text-orange text-center">Phone</th>                   
                     <th scope="col" class="text-orange text-center">Subject</th>
                    
                    <th scope="col" class="text-orange text-center">Message</th>
           ...
           <%
                    ...
                    <tr>
                        ...
                        <td class="text-center"><%= rs.getString("subject") %></td>
                        <td class="text-center"><%= rs.getString("message") %></td>
                      
                     
                        <td class="text-center">
                            <button class="bg-danger">
                                <a href="deletecontac.jsp?id=<%= rs.getInt("id") %>">Delete</a>
                            </button>
                        </td>
                    </tr>
                    <%
